...
scanBlocks = []
if (batch==1):
  scanBlocks.append(gridBlock(600,  900, 100, 100))
  scanBlocks.append(gridBlock(900, 1500, 50, 100))
  scanBlocks.append(gridBlock(1500, 2501, 100, 100))
elif (batch==2): scanBlocks.append(gridBlock(0,  1001, 50, 50))
minDM = 87
